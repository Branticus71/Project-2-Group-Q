...
```{r}
get_wine <- function(type, price= 6000, number = 100, API = "965047400ad841198f2fd834535db269"){
...
```{r, eval=FALSE}
getminmacros <- function(minCalories, API = "ca0e515fe1024fd489a76a3d88fcb775"){
