...
table(cuisine_rec_df$Cuisine,cuisine_rec_df$Diet)
table(cuisine_Amerivegrec_df$Cuisine,cuisine_Amerivegrec_df$Diet)
table(cuisine_Chinesevegrec_df$Cuisine,cuisine_Chinesevegrec_df$Diet)
