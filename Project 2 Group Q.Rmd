...
```{r}
library(ggplot2)
gwine <- ggplot(data = wine_rec_df, aes(x = factor(price), y = ratingCount,))
gwine + geom_point(aes(color = type), position = "jitter") + xlab("price") + ylab("rating") + scale_x_discrete(breaks=1:200)
